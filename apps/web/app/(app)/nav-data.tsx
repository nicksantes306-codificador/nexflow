...
export const NAV_ICONS = {
  ...
  box: <svg className="ic" viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.7l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.7l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><path d="m3.3 7 8.7 5 8.7-5M12 22V12" /></svg>,
};
...
export const PRINCIPAL: NavItemData[] = [
  ...
  { id: "estoque", label: "Estoque", icon: NAV_ICONS.box, desc: "Materiais e produtos: quantidade, mínimo, custo e preço" },
